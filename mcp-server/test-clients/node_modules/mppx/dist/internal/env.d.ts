...
declare const variables: {
    readonly realm: readonly ["FLY_APP_NAME", "HEROKU_APP_NAME", "HOST", "HOSTNAME", "MPP_REALM", "RAILWAY_PUBLIC_DOMAIN", "RENDER_EXTERNAL_HOSTNAME", "VERCEL_URL", "WEBSITE_HOSTNAME"];
