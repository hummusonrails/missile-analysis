    ...
    return (options) => {
        ...
        return Object.assign(async (input) => {
            ...
            // output (e.g. `feePayer` differs between 402 and credential calls).
            {
                ...
                const routeDetails = (routeReq.methodDetails ?? {});
                const echoedDetails = (echoedReq.methodDetails ?? {});
    ...
    return async (input) => {
        ...
        if (paymentHeader) {
            ...
            if (credential) {
                ...
                const credDetails = (credReq.methodDetails ?? {});
                ...
                const candidates = handlers.filter((h) => {
                    ...
                    if (!canonical)
                        return true;
                    const canonicalDetails = (canonical.methodDetails ?? {});
