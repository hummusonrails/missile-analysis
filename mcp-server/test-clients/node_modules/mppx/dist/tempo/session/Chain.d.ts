 ...
 */
export declare function settleOnChain(client: Client, escrowContract: Address, voucher: SignedVoucher, feePayer?: Account | undefined): Promise<Hex>;
/**
 * Submit a close transaction on-chain.
 */
export declare function closeOnChain(client: Client, escrowContract: Address, voucher: SignedVoucher, account?: Account, feePayer?: Account | undefined): Promise<Hex>;
